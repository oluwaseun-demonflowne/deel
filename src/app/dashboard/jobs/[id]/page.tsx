...
const Page = () => {
  ...
  return (
    <div className="px-6 flex border py-6">
      <div className="flex w-[70%] border-r pr-6 flex-col gap-4">
        <div className="flex items-center space-x-2">
          ...
          <div className="flex flex-col justify-center">
            <h1 className="text-3xl  font-semibold">{job[0].jobTitle}</h1>
      ...
      <div className="w-[30%] space-y-4 px-6">
        <div>
