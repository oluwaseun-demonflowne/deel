...
const Page = () => {
  ...
  return (
    <div className="px-3 md:px-6 flex gap-6 md:gap-0 max-md:flex-col border py-6">
      <div className="flex md:w-[70%] md:border-r md:pr-6 flex-col gap-4">
        <div className="flex items-center space-x-2">
          ...
          <div className="flex flex-col justify-center">
            ...
            <div className="flex flex-wrap gap-1  md:gap-4 items-center text-[15px]">
        ...
        <h4 className="text-[15px] tracking-wide">{job[0].jobDescription}</h4>
        <div>
          <p className="font-bold text-[#4098fd]">Skills to have</p>
          <ul className="flex flex-wrap text-[15px] gap-2">
        ...
        <div>
          ...
          <ul className="text-[15px] space-y-1 pl-4 mt-2">
      ...
      <div className="md:w-[30%] space-y-4 md:px-6">
        <div>
          ...
          <h4 className="text-[15px] tracking-wide">{job[0].jobExperience}</h4>
        </div>
        <div>
          <h4 className="font-bold">-Job Education</h4>
          <h4 className="text-[15px] tracking-wide">{job[0].jobEducation}</h4>
        </div>
        <div>
          <h4 className="font-bold">-Job Compensation</h4>
          <h4 className="text-[15px] tracking-wide">{job[0].jobCompensation}</h4>
        </div>
